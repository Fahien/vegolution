...
public:
    ...
    static Vehicle* create(std::string name, int healthMax, int velocity, int delay, Bullet* bullet,
                           cocos2d::Vec2 offset, bool gravity);

    inline float getVelocity() const
    { return velocity_; }

    inline int getHealthMax() const
    { return healthMax_; }
    ...
    inline cocos2d::Vec2 getTap() const
    { return tap_; }
